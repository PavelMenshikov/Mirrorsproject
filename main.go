...
func main() {
	...
	for update := range updates {
		if update.Message != nil { // Если пришло сообщение
			...
			case "practice_4":
				responseText = "В современном мире тревога часто становится нашим постоянным спутником, проявляясь в самых разных формах — от легкого беспокойства до серьезных приступов паники. Мы часто ищем способы справиться с уже возникшей тревогой, но важно также научиться предвосхищать её и понимать её природу.\n\n" +
					"Я хочу поделиться с вами упражнением под названием \"Разговор с тревогой\", которое однажды передала мне одна из моих любимых педагогов. Это упражнение помогло мне, и теперь я рекомендую его своим клиентам и друзьям. Оно предлагает пообщаться с вашей тревогой как с живым собеседником, что поможет вам глубже понять свои страхи и желания.\n\n" +
					"Для выполнения упражнения найдите тихое место, где вас никто не потревожит. Вам понадобятся ручка, бумага и немного воображения. Я предложу вам серию вопросов, которые помогут раскрыть вашу тревогу и научиться с ней взаимодействовать. Постарайтесь отвечать на вопросы постепенно, не заглядывая вперед, и не торопитесь с ответами. После выполнения упражнения у вас останется инструмент для создания дневника саморефлексии, который поможет вам не только лучше понимать себя, но и планировать свою дальнейшую жизнь.\n\n" +
					"Теперь приступим к упражнению:\n\n" +
					"1. С какими сложностями я опасаюсь столкнуться?\n\n" +
					"2. Представьте себя в будущем. Как вы выглядите?\n\n" +
					"3. Что вы чувствуете, когда представляете этот образ?\n\n" +
					"4. О чем говорит ваша тревога? Какие страхи она поднимает?\n\n" +
					"5. Чего именно вы боитесь лишиться?\n\n" +
					"6. Оцените свою тревогу по 100-балльной шкале. Какой балл вы бы поставили сейчас?\n\n" +
					"7. Если бы ваша тревога могла говорить, что бы она вам сказала?\n\n" +
					"8. Что могло бы снизить вашу тревогу на 1-2 балла? Как можно уменьшить риск?\n\n" +
					"9. Как вы можете сделать ситуацию более безопасной для себя?\n\n" +
					"10. Чем вы готовы рискнуть, чтобы двигаться вперед?\n\n" +
					"11. Представьте, что вы справились с тревогой. Как это изменило вашу жизнь?\n\n" +
					"12. Кем вы станете в глазах других людей, близких, коллег, клиентов после того, как справитесь с тревогой?\n\n" +
					"13. Если вы уже управляете своей тревогой, что вы теряете вместе с ней?\n\n" +
					"14. Составьте план из 5-10 пунктов: какие советы дала вам ваша тревога? От чего она вас оберегает? Как вы сможете со всем справиться?\n\n" +
					"Саморефлексия не может быть использована как терапия. Вы всегда можете обратиться за профессиональной поддержкой. Психологическая помощь — это не признак слабости, а шаг к лучшему пониманию себя и улучшению качества жизни. Будьте бережны к себе и близким.\n\n" +
					"Автор - Айна JivAya для связи [https://taplink.cc/jivaya_psy](https://taplink.cc/jivaya_psy), [https://t.me/JivAya_psy](https://t.me/JivAya_psy)"
